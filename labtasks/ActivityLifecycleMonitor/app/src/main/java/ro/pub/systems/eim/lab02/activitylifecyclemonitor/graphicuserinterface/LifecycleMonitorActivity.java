...
/*        Log.d(Constants.TAG, "Create method");
        if(savedInstanceState != null){
    ...
    public void onSaveInstanceState(Bundle savedInstanceState){
        ...
        if(checkBox.isChecked()){
            ...
            savedInstanceState.putString(Constants.USERNAME_EDIT_TEXT, username.toString());
            savedInstanceState.putString(Constants.PASSWORD_EDIT_TEXT, password.toString());
            Log.d(Constants.TAG, "Username: " + username.toString());
            Log.d(Constants.TAG, "Password: " + password.toString());
        }
    ...
    public void onRestoreInstanceState(Bundle savedInstanceState){
        ...
        CheckBox checkBox = (CheckBox)findViewById(R.id.remember_me_checkbox);
        Log.d(Constants.TAG, "Restore method");
        if(savedInstanceState != null && savedInstanceState.getBoolean(Constants.REMEMBER_ME_CHECKBOX)){
            String username = savedInstanceState.getString(Constants.USERNAME_EDIT_TEXT);
            String password = savedInstanceState.getString(Constants.PASSWORD_EDIT_TEXT);
            ((EditText) findViewById(R.id.username_edit_text)).setText(username);
            ((EditText) findViewById(R.id.password_edit_text)).setText(password);
